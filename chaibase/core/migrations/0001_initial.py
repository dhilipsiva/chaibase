# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-07 16:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('is_deleted', models.BooleanField(default=False)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'Admin'), (5, 'Inspector'), (2, 'Manager'), (3, 'Supervisor'), (-1, 'Unknown'), (4, 'Writer')], default=-1)),
                ('factory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='staffs', to='core.Factory')),
